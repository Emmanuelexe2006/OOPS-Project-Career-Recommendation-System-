...
public class DatabaseSetup {
    ...
    private static void insertData(Statement stmt) throws SQLException {
        String[] inserts = {
                ...
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Fashion Stylist', 'Fashion,Styling,Creativity,Trends', 'Styles clothes.', '$40k - $100k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Makeup Artist', 'Makeup,Cosmetics,Creativity,Art', 'Applies makeup.', '$30k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Event Planner', 'Planning,Organization,Communication,Creativity', 'Plans events.', '$40k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Travel Agent', 'Travel,Planning,Customer Service,Geography', 'Books trips.', '$35k - $60k', 'Low')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Flight Instructor', 'Aviation,Teaching,Patience,Communication', 'Teaches flying.', '$40k - $80k', 'High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Robotics Engineer', 'Robotics,Engineering,Programming,Mathematics', 'Builds robots.', '$80k - $140k', 'Very High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Environmental Scientist', 'Environment,Science,Research,Biology', 'Protects nature.', '$50k - $90k', 'High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Zoologist', 'Animals,Biology,Research,Outdoors', 'Studies animals.', '$50k - $80k', 'High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Landscaper', 'Landscaping,Plants,Outdoors,Hard Work', 'Maintains gardens.', '$30k - $60k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('HVAC Technician', 'HVAC,Repair,Tools,Mechanical', 'Fixes AC/Heating.', '$45k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Public Relations Specialist', 'Communication,Media,Writing,Strategy', 'Manages image.', '$50k - $90k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Economist', 'Economics,Mathematics,Analysis,Research', 'Studies economy.', '$80k - $150k', 'Very High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Radiologic Technologist', 'X-Ray,Medical Imaging,Patient Care,Science', 'Takes X-rays.', '$50k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Occupational Therapist', 'Therapy,Patient Care,Empathy,Health', 'Helps daily living.', '$70k - $100k', 'High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('School Counselor', 'Counseling,Education,Empathy,Communication', 'Helps students.', '$50k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Paralegal', 'Law,Research,Writing,Organization', 'Assists lawyers.', '$45k - $75k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Detective', 'Investigation,Law Enforcement,Analysis,Patience', 'Solves crimes.', '$60k - $100k', 'High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Sound Engineer', 'Audio,Technology,Music,Hearing', 'Records sound.', '$40k - $80k', 'Medium')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Film Director', 'Directing,Storytelling,Leadership,Creativity', 'Directs movies.', '$60k - $150k+', 'Very High')",
                "INSERT INTO careers (title, skills, description, salary, difficulty) VALUES ('Air Traffic Controller', 'Aviation,Focus,Stress Management,Communication', 'Directs planes.', '$100k - $180k', 'Extreme')"
        };
